        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    <motion.div
                        {...settings}
                        className="fixed inset-y-0 right-0 w-full md:w-[600px] bg-white shadow-2xl z-50 overflow-y-auto border-l border-slate-100 flex flex-col"
                    >
                        {/* Header */}
                        <div className="px-8 py-6 border-b border-slate-100 flex justify-between items-center bg-white/80 sticky top-0 backdrop-blur-md z-10">
                            <div>
                                <h2 className="text-xl font-display font-black text-primary uppercase italic tracking-tight">
                            ...
                            <button onClick={onClose} className="w-8 h-8 rounded-full bg-slate-50 text-slate-400 hover:bg-slate-100 flex items-center justify-center font-bold text-lg">&times;</button>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex-1 p-8 space-y-10">
                            ...
                            <section className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="gender" value={formData.gender} onChange={handleInputChange} className="w-full px-5 py-3 rounded-xl border-2 border-slate-100 bg-white font-bold text-xs text-primary focus:border-primary/20 outline-none">
                            ...
                            {/* Spiritual Section */}
                            <section className="space-y-6 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                                <h4 className="flex items-center text-[10px] font-black uppercase text-slate-400 tracking-[0.3em]">
                                ...
                                <div className="flex items-center justify-between bg-white p-4 rounded-xl border border-slate-100">
                                    <label htmlFor="isBaptised" className="text-xs font-bold text-primary">Baptisé par Immersion</label>
                                    <input
                                        type="checkbox"
                                        id="isBaptised"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select id="status" value={formData.status} onChange={handleInputChange} className="w-full px-5 py-3 rounded-xl border-2 border-slate-100 bg-white font-bold text-xs text-primary focus:border-primary/20 outline-none">
                                    ...
                                    <div>
                                        ...
                                        <select id="role" value={formData.role} onChange={handleInputChange} className="w-full px-5 py-3 rounded-xl border-2 border-slate-100 bg-white font-bold text-xs text-primary focus:border-primary/20 outline-none">
                                            <option value="Fidèle">Fidèle</option>
                                ...
                                <div>
                                    ...
                                    <select 
                                        ...
                                        onChange={handleInputChange} 
                                        className="w-full px-5 py-3 rounded-xl border-2 border-slate-100 bg-white font-bold text-xs text-primary focus:border-primary/20 outline-none"
                                    >
                                ...
                                <div className="p-4 bg-indigo-50/50 rounded-xl border border-indigo-100 space-y-4">
                                    <div className="flex items-center justify-between">
                                        <label htmlFor="isLeader" className="text-xs font-bold text-indigo-900">Responsabilité / Leadership</label>
                                        <input
                                            type="checkbox"
                                            id="isLeader"
                                            checked={formData.isLeader || false}
                                            onChange={handleInputChange}
                                            className="w-5 h-5 text-indigo-600 border-indigo-200 rounded focus:ring-indigo-500"
                                        />
                                    </div>
                                    ...
                                    {formData.isLeader && (
                                        <div className="animate-fade-in space-y-3">
                                            <div>
                                                ...
                                                <select id="leadershipLevel" value={formData.leadershipLevel || ''} onChange={handleInputChange} className="w-full px-4 py-2 rounded-lg border border-indigo-200 bg-white text-xs font-bold text-indigo-900 focus:ring-2 focus:ring-indigo-100 outline-none">
                                        ...
                                        <div className="animate-fade-in space-y-3">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={handleInputChange}
                                                    className="w-full px-4 py-2 rounded-lg border border-green-200 bg-white text-xs font-bold text-green-900 focus:ring-2 focus:ring-green-100 outline-none"
                                                >
                            ...
                            {/* Footer Actions */}
                            <div className="flex flex-col-reverse sm:flex-row justify-end gap-4 pt-10 border-t border-slate-50 mt-auto bg-white sticky bottom-0 pb-4">
                                {isEditing && (
                                    <Button
                                        type="button"
                                        variant="ghost"
                                ...
                                <Button 
                                    ...
                                    className="px-10 py-4 bg-primary text-white rounded-xl shadow-premium uppercase font-black tracking-widest text-xs hover:scale-[1.02] transition-transform"
                                >
