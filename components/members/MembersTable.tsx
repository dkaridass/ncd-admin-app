                ...
                <tbody className="divide-y divide-slate-50">
                    {members.map((member) => (
                        <tr
                            ...
                            className="group hover:bg-indigo-50 dark:bg-indigo-900/20/10 transition-colors cursor-pointer"
                        >
                            ...
                            <td className="px-6 py-5 hidden md:table-cell">
                                <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                                    <div className="w-6 h-6 rounded-full bg-slate-50 dark:bg-white/[0.02] flex items-center justify-center text-slate-400">
