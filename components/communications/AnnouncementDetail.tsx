    ...
    return (
        <div className="flex flex-col h-full bg-white custom-scrollbar overflow-y-auto">
            ...
            <div className="md:hidden p-4 border-b border-slate-100">
                <button onClick={onClose} className="text-xs font-bold text-slate-500 uppercase tracking-widest">
                    ← Retour
                </button>
            </div>
            ...
            <div className="p-8 md:p-12 max-w-4xl mx-auto w-full">
                ...
                <div className="mb-10 border-b border-slate-100 pb-8">
                    <div className="flex flex-wrap gap-4 mb-6">
                        ...
                        <span className="px-3 py-1 rounded-full bg-slate-100 text-slate-500 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                ...
                {/* Content */}
                <div className="prose prose-slate max-w-none prose-p:leading-loose prose-headings:font-display prose-a:text-primary">
                    <p className="whitespace-pre-line text-slate-600 text-lg leading-relaxed">
