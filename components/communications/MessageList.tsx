                        ...
                        {announcements.map((announcement) => (
                            <li key={announcement.id}>
                                <button
                                    ...
                                    className={`w-full text-left p-6 transition-all hover:bg-slate-50 relative group ${selectedId === announcement.id ? 'bg-primary/5 hover:bg-primary/5' : ''
                                        }`}
                                >
                                    ...
                                    <div className="flex justify-between items-start mb-2">
                                        <h4 className={`text-sm font-bold truncate pr-4 ${selectedId === announcement.id ? 'text-primary' : 'text-slate-700'}`}>
                                            {announcement.title}
                                        </h4>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-slate-100 text-slate-500">
