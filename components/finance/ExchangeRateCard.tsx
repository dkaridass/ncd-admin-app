...
const ExchangeRateCard: React.FC<ExchangeRateCardProps> = ({ className = '' }) => {
    ...
    return (
        <motion.div
            ...
            className={`bg-gradient-to-br from-emerald-50 to-teal-50 p-4 rounded-2xl border border-emerald-100 shadow-sm hover:shadow-md transition-shadow ${className}`}
        >
            ...
            <div className="mt-3 pt-3 border-t border-emerald-100">
                <div className="grid grid-cols-2 gap-2 text-[10px]">
                    <div className="bg-white/50 p-1.5 rounded">
                        ...
                        <p className="text-slate-600">{(rate * 100).toLocaleString('fr-FR', { maximumFractionDigits: 0 })} FC</p>
                    </div>
                    <div className="bg-white/50 p-1.5 rounded">
                        <p className="text-emerald-600 font-bold">10,000 FC</p>
                        <p className="text-slate-600">${(10000 / rate).toFixed(2)} USD</p>
                    </div>
                </div>
            </div>
        </motion.div>
