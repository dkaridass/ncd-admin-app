...
const RevenueChart: React.FC<Props> = ({ records, periodLabel }) => {
    ...
    if (chartData.length === 0) {
        return (
            <Card className="border-none shadow-soft rounded-2xl p-8">
                <h3 className="text-lg font-bold text-slate-700 mb-4">Tendances des Revenus</h3>
    ...
    return (
        <Card className="border-none shadow-soft rounded-2xl p-8">
            <h3 className="text-lg font-bold text-slate-700 mb-6">Tendances des Revenus - {periodLabel}</h3>
